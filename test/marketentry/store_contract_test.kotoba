...
(defn- exercise [s]
  (store/commit-record! s {:effect :engagement/upsert
                           :value {:id "eng-x" :operator "X SARL" :jurisdiction "BEN"
                                   :base-fee 100 :monthly-rate 10 :monitoring-months 1
                                   :claimed-fee 110.0
                                   :mpme-status? true :base-price 1000 :claimed-evaluated-price 950.0
  ...
  (store/commit-record! s {:effect :assessment/set
                           :path ["eng-x"]
                           :payload {:jurisdiction "BEN" :checklist ["a"] :spec-basis "x"}})
